...
# ===============================
# 4. CLEAN OLD GOVERNOR (STRICT + SAFE)
# ===============================
text = re.sub(
...
# ===============================
# 6. SAFE CALL PATCH (REGEX STRUCTURED)
# ===============================
text = re.sub(
...
# ===============================
# 7. PRE-FLIGHT CLEAN + INSERT (ROBUST)
# ===============================
# remove ALL old preflight blocks
text = re.sub(
    r"' ===== V6\.\d+ PRE-FLIGHT SIMULATION =====[\s\S]*?(End If|=======================================)",
    "",
    text
)
...
# ===============================
# 8. STRONG STRUCTURAL VALIDATION
# ===============================
