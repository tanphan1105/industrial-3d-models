...
(function () {
    ...
    function updateModelInfo() {
        ...
        if (m) {
            priceTag.textContent = `$${m.personal_price} / $${m.professional_price}`;
    ...
    document.getElementById('wt3d-fill-all-btn').addEventListener('click', async () => {
        ...
        try {
            ...
            if (priceInput) {
                setReactInputValue(priceInput, (m.professional_price || 79).toString());
                report.push(`Price: $${m.professional_price || 79}`);
            }
