...
// @version      1.0.0
// @description  Tu dong dien Title, Description, 25 Tags, Tech Specs (Materials, UVW, Polys/Verts) va ho tro mo thu muc media 1-click cho CGTrader.com
// @author       Phan Trong Tan (@tanphan1105)
// @match        https://www.cgtrader.com/profile/upload/*
// @match        https://www.cgtrader.com/publisher/models/*
// @grant        none
// ==/UserScript==
...
Created by WaterTreatment3D Engineering Studio.",
            ...
            "vertices": 62400,
            "cgtrader_price": 79,
            "cgtrader_sale_price": 39.5,
            "cgtrader_net_estimate": 29.62
        },
        {
...
Created by WaterTreatment3D Engineering Studio.",
            ...
            "vertices": 62400,
            "cgtrader_price": 59,
            "cgtrader_sale_price": 29.5,
            "cgtrader_net_estimate": 22.12
        },
        {
...
// =====================================================================
    ...
    function createFloatingPanel() {
        ...
        panel.innerHTML = `
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 4px; margin-bottom: 8px;">
                ...
                <button id="wt3d-cp-tags" style="background: rgba(255, 255, 255, 0.06); border: 1px solid rgba(255, 255, 255, 0.1); color: #cbd5e1; padding: 5px; border-radius: 4px; font-size: 10px; font-weight: 600; cursor: pointer;">🏷️ 25 Tags</button>
            </div>
    ...
    document.getElementById('wt3d-cp-tags').addEventListener('click', () => {
        ...
        if (m) {
            ...
            statusText.textContent = '🏷️ Đã copy 25 Tags!';
            statusText.style.color = '#10b981';
        }
    });
    ...
    document.getElementById('wt3d-fill-all-btn').addEventListener('click', async () => {
        ...
        try {
            ...
            statusText.textContent = '⏳ [3/6] Đang gõ 25 Tags chuẩn CGTrader...';
            statusText.style.color = '#38bdf8';
            ...
            if (tagInput && tagsList.length > 0) {
                let tagsAdded = 0;
                for (const tag of tagsList.slice(0, 25)) {
                    try {
                        tagInput.focus();
                        tagInput.click();
                        await humanDelay(100, 200);
