  ...
  "01_Pumps_and_Motors": [
    {
      ...
      "tags": ["industrial", "water", "treatment", "pump", "valve", "filter", "tank", "equipment", "machinery", "engineering", "hardware", "steel", "stainless", "cad", "props"],
                ...
                for (const tag of m.tags.slice(0, 16)) {
                    try {
                        ...
                        const allCandidates = Array.from(document.querySelectorAll('[role="option"], [role="listbox"] li, ul[class*="autocomplete"] li, ul[class*="menu"] li, div[class*="option"], div[role="button"]')).filter(el => {
                            ...
                            return txt === tag.toLowerCase() || txt.includes(tag.toLowerCase()) || (r.top >= tagRect.bottom - 15 && r.top <= tagRect.bottom + 350 && txt.length > 0 && txt.length < 35);
                        });
