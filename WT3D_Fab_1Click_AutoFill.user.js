(function() {
  ...
  "01_Pumps_and_Motors": [
    {
      ...
      "tags": ["industrial", "water", "treatment", "system", "pump", "valve", "filter", "tank", "skid", "machinery", "equipment", "piping", "mechanical", "stainless", "steel", "cad"],
  ...
  "04_Valves_and_Actuators": [
    ...
    {
      "name": "SS304_Globe_Valve_DN25_PPR_Male_Thread",
      "title": "SS304 Globe Valve DN25 with PPR Male Thread Adapters - Industrial CAD 3D Model",
      "personal_price": 19.99,
      "professional_price": 29.99,
      "category": "Tools, Objects & Decor",
      "tags": ["industrial", "water", "treatment", "system", "pump", "valve", "filter", "tank", "skid", "machinery", "equipment", "piping", "mechanical", "stainless", "steel", "cad"],
      "description": "SS304 Globe Valve DN25 with PPR Male Thread Adapters - Professional Industrial 3D CAD Model\nHigh-precision, production-grade 3D model designed specifically for Unreal Engine, Blender, Unity, CAD Engineering, EPC Simulation, Digital Twins, and Architecture Visualization.\n\nKey Features & Technical Specifications::\n- True Real-World Scale (1:1 Meters): Perfectly aligned with origin coordinate (0,0,0) and Y-Up / Z-Up compatibility.\n- Universal Multi-CAD & DCC Support: Native compatibility with all leading 3D software and game engines.\n- Clean Topology & Clean Meshing: Optimized geometry with clear normals, zero flipped faces, and separated functional components.\n- Engineering Accuracy: Modeled according to industrial DIN / ISO / ANSI standards for industrial water treatment and mechanical engineering plants.\n\nIncluded Formats in Package::\n1. FBX (Unreal Engine 5.x, Unity, 3ds Max, Maya ready)\n2. OBJ + MTL (Universal 3D exchange)\n3. STEP (.stp / .step) (Universal Solid CAD geometry for SolidWorks, Inventor, Fusion 360, Rhino)\n4. GLTF / GLB (Web 3D, AR/VR, Blender)\n5. SAT (.sat) (ACIS standard geometry)\n6. 2D Engineering Blueprint Sheets (DWG, Vector PDF, High-Res PNG)\n\nIdeal Use Cases::\n- Industrial Plant Design & Simulation (EPC, BIM, Architecture)\n- Game Development & Real-time Visualization (Unreal Engine / Unity)\n- VR/AR Training & Digital Twin Systems\n- High-End Cinematic Rendering and Marketing Media\n\nCreated by WaterTreatment3D Engineering Studio.",
      "zip_path": "D:\\INVENTOR_DATA\\05_STANDARD_COMPONENTS\\04_Valves_and_Actuators\\SS304_Globe_Valve_DN25_PPR_Male_Thread\\06_Renders_and_Media\\01_Marketplace_Upload_Package\\SS304_Globe_Valve_DN25_PPR_Male_Thread_Universal_CAD.zip",
      "thumb_path": "D:\\INVENTOR_DATA\\05_STANDARD_COMPONENTS\\04_Valves_and_Actuators\\SS304_Globe_Valve_DN25_PPR_Male_Thread\\06_Renders_and_Media\\04_Watermarked_Exports\\SS304_Globe_Valve_DN25_PPR_Male_Thread_01_Hero3D_Iso_TopRight.png",
      "folder_path": "D:\\INVENTOR_DATA\\05_STANDARD_COMPONENTS\\04_Valves_and_Actuators\\SS304_Globe_Valve_DN25_PPR_Male_Thread\\06_Renders_and_Media"
    },
    {
      "name": "SS304_Swing_Check_Valve_DN32_PPR_Male_Thread",
      "title": "SS304 Swing Check Valve DN32 with PPR Male Thread Adapters - Industrial CAD 3D Model",
      "personal_price": 19.99,
      "professional_price": 29.99,
      "category": "Tools, Objects & Decor",
      "tags": ["industrial", "water", "treatment", "system", "pump", "valve", "filter", "tank", "skid", "machinery", "equipment", "piping", "mechanical", "stainless", "steel", "cad"],
      "description": "SS304 Swing Check Valve DN32 with PPR Male Thread Adapters - Professional Industrial 3D CAD Model\nHigh-precision, production-grade 3D model designed specifically for Unreal Engine, Blender, Unity, CAD Engineering, EPC Simulation, Digital Twins, and Architecture Visualization.\n\nKey Features & Technical Specifications::\n- True Real-World Scale (1:1 Meters): Perfectly aligned with origin coordinate (0,0,0) and Y-Up / Z-Up compatibility.\n- Universal Multi-CAD & DCC Support: Native compatibility with all leading 3D software and game engines.\n- Clean Topology & Clean Meshing: Optimized geometry with clear normals, zero flipped faces, and separated functional components.\n- Engineering Accuracy: Modeled according to industrial DIN / ISO / ANSI standards for industrial water treatment and mechanical engineering plants.\n\nIncluded Formats in Package::\n1. FBX (Unreal Engine 5.x, Unity, 3ds Max, Maya ready)\n2. OBJ + MTL (Universal 3D exchange)\n3. STEP (.stp / .step) (Universal Solid CAD geometry for SolidWorks, Inventor, Fusion 360, Rhino)\n4. GLTF / GLB (Web 3D, AR/VR, Blender)\n5. SAT (.sat) (ACIS standard geometry)\n6. 2D Engineering Blueprint Sheets (DWG, Vector PDF, High-Res PNG)\n\nIdeal Use Cases::\n- Industrial Plant Design & Simulation (EPC, BIM, Architecture)\n- Game Development & Real-time Visualization (Unreal Engine / Unity)\n- VR/AR Training & Digital Twin Systems\n- High-End Cinematic Rendering and Marketing Media\n\nCreated by WaterTreatment3D Engineering Studio.",
      "zip_path": "D:\\INVENTOR_DATA\\05_STANDARD_COMPONENTS\\04_Valves_and_Actuators\\SS304_Swing_Check_Valve_DN32_PPR_Male_Thread\\06_Renders_and_Media\\01_Marketplace_Upload_Package\\SS304_Swing_Check_Valve_DN32_PPR_Male_Thread_Universal_CAD.zip",
      "thumb_path": "D:\\INVENTOR_DATA\\05_STANDARD_COMPONENTS\\04_Valves_and_Actuators\\SS304_Swing_Check_Valve_DN32_PPR_Male_Thread\\06_Renders_and_Media\\04_Watermarked_Exports\\SS304_Swing_Check_Valve_DN32_PPR_Male_Thread_01_Hero3D_Iso_TopRight.png",
      "folder_path": "D:\\INVENTOR_DATA\\05_STANDARD_COMPONENTS\\04_Valves_and_Actuators\\SS304_Swing_Check_Valve_DN32_PPR_Male_Thread\\06_Renders_and_Media"
    },
    {
  ...
  "10_Skid_Structure_and_Mechanical": [
    ...
    async function selectFabCategory(category) {
        ...
        try {
            // Neu da chon roi thi skip
            const alreadySelected = Array.from(document.querySelectorAll('*')).find(el => {
                if (el.id?.includes('wt3d') || el.closest?.('#wt3d-fab-floating-panel')) return false;
                const t = (el.textContent || '').trim();
                return t === 'Tools, Objects & Decor' || t === 'Tools, Objects & Decor / Industrial';
            });
            if (alreadySelected && alreadySelected.offsetParent !== null) {
                console.log('[WT3D] Category already selected, skip');
                return true;
            }

            // Tim trigger dropdown Category tu label "Category *"
            let catTrigger = (() => {
                const allEls = Array.from(document.querySelectorAll('label, div, span, p, h3, h4'));
                for (const el of allEls) {
                    const t = (el.textContent || '').trim();
                    if ((t === 'Category *' || t === 'Category') && el.tagName !== 'BUTTON' && !el.id?.includes('wt3d')) {
                        let p = el.parentElement;
                        for (let i = 0; i < 6 && p; i++) {
                            const btn = p.querySelector('button, [role="combobox"], [role="button"], input, div[role="textbox"], div[tabindex="0"]');
                            if (btn && !btn.id?.includes('wt3d') && !btn.closest?.('#wt3d-fab-floating-panel')) return btn;
                            p = p.parentElement;
                        }
                    }
                }
                // Fallback: tim element co chua text category hoac icon chevron gan do
            ...
            if (!catTrigger) {
                console.log('[WT3D] Category trigger NOT found');
                return false;
            }

            console.log('[WT3D] Category trigger clicked:', catTrigger.tagName, catTrigger.textContent?.trim().substring(0, 30));
            catTrigger.scrollIntoView({ block: 'center' });
            await humanDelay(200, 350);
            await humanClick(catTrigger);
            await humanDelay(500, 800); // Cho dropdown mo ra

            // Neu trong dropdown co o search input thi go "Tools" vao
            const dropdownInput = document.querySelector('[role="listbox"] input, [role="dialog"] input, div[class*="dropdown"] input, div[class*="menu"] input, div[class*="popup"] input, div[class*="modal"] input, input[placeholder*="Search" i]');
            if (dropdownInput && !dropdownInput.id?.includes('wt3d') && dropdownInput !== catTrigger) {
                console.log('[WT3D] Found dropdown search input, typing Tools...');
                dropdownInput.focus();
                const nSet = Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, 'value')?.set;
            ...
            // Tim va click option "Tools, Objects & Decor"
            const TARGET_TEXT = 'tools, objects & decor';
            const scanStart = Date.now();
            let matched = null;

            while (Date.now() - scanStart < 4000 && !matched) {
                const candidates = Array.from(document.querySelectorAll('[role="option"], [role="menuitem"], li, button, div, span')).filter(el => {
                    if (el.id?.includes('wt3d') || el.closest?.('#wt3d-fab-floating-panel')) return false;
                    if (el === catTrigger) return false;
                    if (el.offsetParent === null) return false;
                    const t = (el.textContent || '').trim().toLowerCase();
                    return t === TARGET_TEXT || (t.startsWith(TARGET_TEXT) && t.length < 50);
                });
            ...
            console.log('[WT3D] Category error:', e.message);
            return false;
        }
    }
    ...
    function createFloatingPanel() {
        ...
        panel.innerHTML = `
            <div id="wt3d-drag-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; border-bottom: 1px solid #334155; padding-bottom: 8px; cursor: move; user-select: none;">
        ...
        (function makeDraggable(el) {
            const header = el.querySelector('#wt3d-drag-header') || el.firstElementChild;
        ...
        document.getElementById('wt3d-fill-btn')?.addEventListener('click', executeWithEscAbort(statusText, '1-Click Toàn Bộ Form', async () => {
            ...
            for (const faq of faqsToAdd) {
                try {
                    ...
                    await humanDelay(900, 1200); // Cho modal dong han truoc khi tim Add FAQ tiep theo
                } catch (err) {
