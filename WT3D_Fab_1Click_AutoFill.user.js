  ...
  "01_Pumps_and_Motors": [
    {
      ...
      "tags": ["filter", "vessel", "treatment", "system", "water", "tank", "skid", "industrial", "pump", "machinery", "equipment", "piping", "mechanical", "stainless", "realistic"],
  ...
  "10_Skid_Structure_and_Mechanical": [
    ...
    async function selectFabCategory(category) {
        ...
        try {
            ...
            // Tim trigger: leo cay tu label "Category *"
            let catTrigger = null;
            ...
            for (const el of allEls) {
                ...
                if ((t === 'Category *' || t === 'Category') && el.tagName !== 'BUTTON' &&
                    ...
                    for (let i = 0; i < 6 && p; i++) {
                        const btn = p.querySelector('button, [role="combobox"], input, div[tabindex="0"]');
